...
namespace MedicalBookingSystem
{
    public partial class MainForm : Form
    {
        ...
        private void RefreshDataGrid()
        {
            dataGridView1.DataSource = _appointmentRepo.GetAll()
                ...
                .Select(a => new
                {
                    ...
                    Телефон = a.Patient.Phone,
                    ID_Пацієнта = a.Patient.Id,
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                _appointmentRepo.Add(addForm.NewAppointment);
                RefreshDataGrid();
                MessageBox.Show($"Запис створено! ID пацієнта: {addForm.NewAppointment.Patient.Id}",
        ...
        private void btnFindById_Click(object sender, EventArgs e)
        {
            ...
            {
                var appointments = _appointmentRepo.Find(a => a.Patient.Id == patientId);
